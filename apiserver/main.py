...
app_version = "1.0.0"
app_description = "A FastAPI application for generating traffic to test server performance."
...
@app.get("/")
async def root():
    return {"message": "Shopping API Server is running"}
...
if __name__ == "__main__":
    ...
    url = f"http://0.0.0.0:{settings.port}/"
